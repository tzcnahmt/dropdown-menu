...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
// COLOR PALETTE
var palette = ["#f2d074", "#e76051", "#6ebe90", "#64cac5", "#f6a052", "#f8c6c6"]; // SELECTORS

var background = document.querySelector(".nav-left");
var links = document.querySelectorAll(".nav-link");
var contentImg = document.querySelectorAll(".content-img");
var rightBackground = document.querySelector(".nav-right");
var header = document.querySelector("header");
var trigger = document.querySelector(".trigger"); // ANIMATION ON TRIGGER (OPEN & CLOSE)
...
links.forEach(function (link, index) {
  link.addEventListener("mouseover", function () {
    ...
    _gsap.default.to(contentImg[index], {
      duration: 0.35,
      opacity: 1
    });

    contentImg.forEach(function (img, ind) {
      if (ind !== index) {
...
},{"./styles.css":"src/styles.css","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
